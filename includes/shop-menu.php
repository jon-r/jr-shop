...
?>
<div class="nav-top flex-container" id="scrollLock">

  <div class="left" ng-class="{'is-fixed':scroller.fix}" >
    ...
    <menu id="primary-menu" class="nav-left-menu" ng-controller="menuCtrl">
